...
const EXAMPLES = [
  ...
  {
    label: "Tarshid ESPC (SEEC Option C, KSA)",
    text: `This M&V plan follows the SEEC Energy Saving Measurement & Verification User Guide (Version 2, 2024) for a 10-year energy savings performance contract at a government university campus in Riyadh. The project targets 25% energy reduction through chiller plant optimization, building envelope improvements, and LED lighting retrofits across 14 buildings. IPMVP Option C is selected with the measurement boundary at the whole-campus level using existing Saudi Electricity Company (SEC) revenue meters at the main distribution point. The baseline is constructed from 24 months of monthly billing data (1445\u20131446 H) to capture two full summer cooling cycles. A multivariable regression model uses outdoor dry-bulb temperature (CDD base 18\u00B0C, Riyadh regional weather station) as the primary independent variable; heating degree days are excluded as negligible for this cooling-dominated profile. Baseline conditions including operating schedules, occupancy patterns, and equipment inventory are documented per SEEC Section 4.4. Routine adjustments normalize for CDD variation between baseline and reporting periods. A non-routine adjustment provision addresses occupancy changes exceeding 15% of occupied floor area, as government buildings in the Kingdom are periodically repurposed between ministries. A 3rd-party M&V Agent, appointed per SEEC Section 2.3, will review this plan during the preparation phase, witness operational verification, and independently verify annual saving reports. Operational verification per SEEC Section 4.5 will confirm ECM installations meet design specifications before the reporting period begins, with quarterly operational checks thereafter. Energy prices are defined in contract Exhibit B and will be applied per the ESCO agreement terms. Interactive effects between lighting heat reduction and HVAC cooling load are acknowledged but are expected to be captured within the whole-facility measurement boundary and are not separately quantified. Savings will be determined with reasonable accuracy using the regression-adjusted baseline. The M&V budget is set at 3% of estimated annual savings. Saving reports will be submitted annually in the format specified by the ESCO contract annex.`,
  },
];
